# -*- coding: utf-8 -*-
"""
Created on Sun Jan  3 03:17:17 2021
...
for i, j in enumerate(np.unique(y_set)):
     plt.scatter(X_set[y_set == j, 0], X_set[y_set == j, 1],
                 c = ListedColormap(('black', 'white','white','white','white','white','red'))(i), label = i)
plt.title('Lojistik Regresyon (Training Set)')
...
plt.title('Lojistik Regresyon (Test set)')
plt.xlabel('Starting position(grid)')
plt.ylabel('Number of pitstops')
plt.legend()
plt.show()